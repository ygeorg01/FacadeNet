...
class BaseOptions():
    def initialize(self, parser):
        ...
        parser.add_argument('--model', type=str, default='autoencoder', help='which model to use')
        # parser.add_argument('--optimizer', type=str, default='swapping_autoencoder', help='which model to use')

        parser.add_argument('--optimizer', type=str, default='autoencoder', help='which model to use')
        ...
        parser.add_argument('--dataroot_h', type=str, default=".")
        parser.add_argument('--dataroot_v', type=str, default=".")
        parser.add_argument('--dataroot_sem', type=str, default=".")
        parser.add_argument('--dataroot_feats', type=str, default=".")
        parser.add_argument('--dataroot_depth', type=str, default=".")
        ...
        parser.add_argument("--netD_va", default="")
        parser.add_argument("--use_antialias", type=util.str2bool, default=True)

        # Train/Eval splits dir
        parser.add_argument("--train_split_dir", type=str, default="")
        parser.add_argument("--eval_split_dir", type=str, default="")
        parser.add_argument("--test_split_dir", type=str, default="")
        parser.add_argument("--generator_name", type=str, default="")

        parser.add_argument("--lambda_sel_L1", type=float, default=0.0)
